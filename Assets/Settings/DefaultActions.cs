...
public partial class @DefaultActions: IInputActionCollection2, IDisposable
{
    ...
    ~@DefaultActions()
    {
        Debug.Assert(!m_Gameplay.enabled, "This will cause a leak and performance issues, DefaultActions.Gameplay.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, DefaultActions.UI.Disable() has not been called.");
    }
