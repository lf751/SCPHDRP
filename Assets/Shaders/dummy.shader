	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( tex2D( _MainTex, uv_MainTex ) * _Color ).rgb;
...
ASEEND*/
//CHKSM=8AD44FC8A92CD8C27652D4987155D5DFC34E4653