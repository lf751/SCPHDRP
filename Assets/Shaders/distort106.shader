	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_DistortionMask = packedInput.ase_texcoord5.xy * _DistortionMask_ST.xy + _DistortionMask_ST.zw;
				float2 uv_MainTex = packedInput.ase_texcoord5.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float mulTime9 = _TimeParameters.x * _DistortionSpeed;
				float2 temp_cast_1 = (mulTime9).xx;
				float2 texCoord3 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + temp_cast_1;
				float layeredBlendVar41 = tex2D( _DistortionMask, uv_DistortionMask ).r;
				float4 layeredBlend41 = ( lerp( ( float4( uv_MainTex, 0.0 , 0.0 ) + ( tex2D( _distortNoise, texCoord3 ) * ( _DistortionEffect * 0.03 ) ) ),float4( uv_MainTex, 0.0 , 0.0 ) , layeredBlendVar41 ) );
				
				surfaceDescription.BaseColor = tex2D( _MainTex, layeredBlend41.rg ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _NormalMap, layeredBlend41.rg ), 1.0f );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_DistortionMask = packedInput.ase_texcoord2.xy * _DistortionMask_ST.xy + _DistortionMask_ST.zw;
				float2 uv_MainTex = packedInput.ase_texcoord2.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float mulTime9 = _TimeParameters.x * _DistortionSpeed;
				float2 temp_cast_1 = (mulTime9).xx;
				float2 texCoord3 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_1;
				float layeredBlendVar41 = tex2D( _DistortionMask, uv_DistortionMask ).r;
				float4 layeredBlend41 = ( lerp( ( float4( uv_MainTex, 0.0 , 0.0 ) + ( tex2D( _distortNoise, texCoord3 ) * ( _DistortionEffect * 0.03 ) ) ),float4( uv_MainTex, 0.0 , 0.0 ) , layeredBlendVar41 ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_DistortionMask = packedInput.ase_texcoord3.xy * _DistortionMask_ST.xy + _DistortionMask_ST.zw;
				float2 uv_MainTex = packedInput.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float mulTime9 = _TimeParameters.x * _DistortionSpeed;
				float2 temp_cast_1 = (mulTime9).xx;
				float2 texCoord3 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_1;
				float layeredBlendVar41 = tex2D( _DistortionMask, uv_DistortionMask ).r;
				float4 layeredBlend41 = ( lerp( ( float4( uv_MainTex, 0.0 , 0.0 ) + ( tex2D( _distortNoise, texCoord3 ) * ( _DistortionEffect * 0.03 ) ) ),float4( uv_MainTex, 0.0 , 0.0 ) , layeredBlendVar41 ) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_DistortionMask = packedInput.ase_texcoord7.xy * _DistortionMask_ST.xy + _DistortionMask_ST.zw;
				float2 uv_MainTex = packedInput.ase_texcoord7.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float mulTime9 = _TimeParameters.x * _DistortionSpeed;
				float2 temp_cast_1 = (mulTime9).xx;
				float2 texCoord3 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + temp_cast_1;
				float layeredBlendVar41 = tex2D( _DistortionMask, uv_DistortionMask ).r;
				float4 layeredBlend41 = ( lerp( ( float4( uv_MainTex, 0.0 , 0.0 ) + ( tex2D( _distortNoise, texCoord3 ) * ( _DistortionEffect * 0.03 ) ) ),float4( uv_MainTex, 0.0 , 0.0 ) , layeredBlendVar41 ) );
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.RangedFloatNode;11;-1187.868,-233.7164;Inherit;False;Property;_DistortionSpeed;Distortion Speed;2;0;Create;True;0;0;0;False;0;False;0.4146917;0.075;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;9;-1297.575,-122.3585;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1055.228,313.8898;Inherit;False;Property;_DistortionEffect;Distortion Effect;3;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-884.0647,399.2668;Inherit;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;0;False;0;False;0.03;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;42;-1093.06,-476.5823;Inherit;True;Property;_distortNoise;distortNoise;7;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;4;-802,-199;Inherit;True;Property;_MainTex;Albedo;0;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;16;-1282.688,170.0206;Inherit;True;Property;_DistortionMask;DistortionMask;4;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
WireConnection;46;4;30;0
WireConnection;46;7;31;0
ASEEND*/
//CHKSM=8682678F70843C8974D6C41CDDC7C981BC7ACB53