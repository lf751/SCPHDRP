...
Shader "custom/oilShader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _baseColor;
			float _bumpSpeed1;
			float _bumpStrength1;
			float _bumpSpeed2;
			float _bumpStrength2;
			float _IOR;
			float _metallic;
			float _smoothness;
						...
						)
			{
				...
				float2 temp_cast_0 = (( _TimeParameters.x * _bumpSpeed1 )).xx;
				float2 texCoord26 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + temp_cast_0;
				float2 temp_output_2_0_g5 = texCoord26;
				...
				float2 temp_cast_1 = (( _TimeParameters.x * _bumpSpeed2 )).xx;
				float2 texCoord28 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + temp_cast_1;
				float2 temp_output_2_0_g6 = texCoord28;
				...
				float4 tex2DNode14_g6 = tex2D( _bump2, temp_output_2_0_g6 );
				float temp_output_4_0_g6 = _bumpStrength2;
				float3 appendResult13_g6 = (float3(1.0 , 0.0 , ( ( tex2D( _bump2, appendResult8_g6 ).g - tex2DNode14_g6.g ) * temp_output_4_0_g6 )));
				float2 appendResult9_g6 = (float2(break6_g6.x , ( break6_g6.y + temp_output_25_0_g6 )));
				float3 appendResult16_g6 = (float3(0.0 , 1.0 , ( ( tex2D( _bump2, appendResult9_g6 ).g - tex2DNode14_g6.g ) * temp_output_4_0_g6 )));
				float3 normalizeResult22_g6 = normalize( cross( appendResult13_g6 , appendResult16_g6 ) );
				float3 temp_output_32_0 = BlendNormal( normalizeResult22_g5 , normalizeResult22_g6 );
				...
				float3 tanNormal11 = temp_output_32_0;
				...
				float dotResult13 = dot( worldNormal11 , V );
				float fresnelNdotV7 = dot( worldNormal11, V );
				float ior7 = _IOR;
				...
				surfaceDescription.Normal = temp_output_32_0;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				Gradient gradient6 = NewGradient( 0, 3, 2, float4( 0.04460192, 0, 1, 0 ), float4( 1, 0, 0.5081825, 0.5029374 ), float4( 0, 1, 0.01039314, 1 ), 0, 0, 0, 0, 0, float2( 1, 0.002944991 ), float2( 1, 0.9735256 ), 0, 0, 0, 0, 0, 0 );
				float2 temp_cast_0 = (( _TimeParameters.x * _bumpSpeed1 )).xx;
				float2 texCoord26 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_0;
				float2 temp_output_2_0_g5 = texCoord26;
				float2 break6_g5 = temp_output_2_0_g5;
				float temp_output_25_0_g5 = ( pow( 0.5 , 3.0 ) * 0.1 );
				float2 appendResult8_g5 = (float2(( break6_g5.x + temp_output_25_0_g5 ) , break6_g5.y));
				...
				float3 normalizeResult22_g5 = normalize( cross( appendResult13_g5 , appendResult16_g5 ) );
				float2 temp_cast_1 = (( _TimeParameters.x * _bumpSpeed2 )).xx;
				float2 texCoord28 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_1;
				float2 temp_output_2_0_g6 = texCoord28;
				float2 break6_g6 = temp_output_2_0_g6;
				float temp_output_25_0_g6 = ( pow( 0.5 , 3.0 ) * 0.1 );
				float2 appendResult8_g6 = (float2(( break6_g6.x + temp_output_25_0_g6 ) , break6_g6.y));
				...
				float dotResult13 = dot( worldNormal11 , ase_worldViewDir );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV7 = dot( worldNormal11, ase_worldViewDir );
				float ior7 = _IOR;
				ior7 = pow( max( ( 1 - ior7 ) / ( 1 + ior7 ) , 0.0001 ), 2 );
				float fresnelNode7 = ( ior7 + ( 1.0 - ior7 ) * pow( max( 1.0 - fresnelNdotV7 , 0.0001 ), 5 ) );
				float4 lerpResult17 = lerp( _baseColor , SampleGradient( gradient6, dotResult13 ) , fresnelNode7);
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_cast_0 = (( _TimeParameters.x * _bumpSpeed1 )).xx;
				float2 texCoord26 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_0;
				float2 temp_output_2_0_g5 = texCoord26;
				float2 break6_g5 = temp_output_2_0_g5;
				float temp_output_25_0_g5 = ( pow( 0.5 , 3.0 ) * 0.1 );
				float2 appendResult8_g5 = (float2(( break6_g5.x + temp_output_25_0_g5 ) , break6_g5.y));
				...
				float3 normalizeResult22_g5 = normalize( cross( appendResult13_g5 , appendResult16_g5 ) );
				float2 temp_cast_1 = (( _TimeParameters.x * _bumpSpeed2 )).xx;
				float2 texCoord28 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_1;
				float2 temp_output_2_0_g6 = texCoord28;
				float2 break6_g6 = temp_output_2_0_g6;
				float temp_output_25_0_g6 = ( pow( 0.5 , 3.0 ) * 0.1 );
				float2 appendResult8_g6 = (float2(( break6_g6.x + temp_output_25_0_g6 ) , break6_g6.y));
		...
		Pass
		{
						...
						)
			{
				...
				Gradient gradient6 = NewGradient( 0, 3, 2, float4( 0.04460192, 0, 1, 0 ), float4( 1, 0, 0.5081825, 0.5029374 ), float4( 0, 1, 0.01039314, 1 ), 0, 0, 0, 0, 0, float2( 1, 0.002944991 ), float2( 1, 0.9735256 ), 0, 0, 0, 0, 0, 0 );
				float2 temp_cast_0 = (( _TimeParameters.x * _bumpSpeed1 )).xx;
				float2 texCoord26 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + temp_cast_0;
				float2 temp_output_2_0_g5 = texCoord26;
				float2 break6_g5 = temp_output_2_0_g5;
				float temp_output_25_0_g5 = ( pow( 0.5 , 3.0 ) * 0.1 );
				float2 appendResult8_g5 = (float2(( break6_g5.x + temp_output_25_0_g5 ) , break6_g5.y));
				...
				float3 normalizeResult22_g5 = normalize( cross( appendResult13_g5 , appendResult16_g5 ) );
				float2 temp_cast_1 = (( _TimeParameters.x * _bumpSpeed2 )).xx;
				float2 texCoord28 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + temp_cast_1;
				float2 temp_output_2_0_g6 = texCoord28;
				float2 break6_g6 = temp_output_2_0_g6;
				float temp_output_25_0_g6 = ( pow( 0.5 , 3.0 ) * 0.1 );
				float2 appendResult8_g6 = (float2(( break6_g6.x + temp_output_25_0_g6 ) , break6_g6.y));
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.RangedFloatNode;23;-2168.186,292.5933;Inherit;False;Property;_bumpSpeed1;bumpSpeed1;7;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;22;-2272.438,182.5495;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-2340.01,514.6114;Inherit;False;Property;_bumpSpeed2;bumpSpeed2;8;0;Create;True;0;0;0;False;0;False;-1;0.34;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-1749.451,356.2643;Inherit;False;Property;_bumpStrength2;bumpStrength2;11;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-1754.651,39.06433;Inherit;False;Property;_bumpStrength1;bumpStrength1;10;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;20;-1686.186,-317.4747;Inherit;True;Property;_bump2;bump2;6;2;[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;18;-1997.635,-114.4036;Inherit;True;Property;_bump;bump;5;2;[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;38;-1372.451,300.3643;Inherit;False;NormalCreate;1;;6;e12f7ae19d416b942820e3932b56220f;0;4;1;SAMPLER2D;;False;2;FLOAT2;0,0;False;3;FLOAT;0.5;False;4;FLOAT;2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1095.111,34.59738;Inherit;False;Property;_IOR;IOR;9;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1;-752.7592,134.6427;Inherit;False;Property;_baseColor;baseColor;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-152.233,148.65;Inherit;False;Property;_metallic;metallic;4;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
WireConnection;41;7;2;0
ASEEND*/
//CHKSM=2DDCE4EE5820E17D3BB6753BE968168E218FF573