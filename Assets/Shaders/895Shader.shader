...
Shader "Custom/895Shader"
{
	Properties
	{
		...
		_StaticTex("StaticTex", 2D) = "white" {}
		_JumpTex("JumpTex", 2D) = "black" {}
		_Intensity("Intensity", Float) = 1
		_Glossiness("Glossiness", Range( 0 , 1)) = 0.5
		_ScareA("Scare Alpha", Float) = 1
		_GlitchAmount("Glitch Amount", Range( 0 , 0.1)) = 0.05
		_GlitchAmountR("Glitch Amount Red", Range( 0 , 0.1)) = 0.05
		_GlitchSpeed("Glitch Speed", Range( 0 , 10)) = 1
		_GlitchWaves("Glitch Waves", Range( 0 , 1000)) = 1
		_RowHeight("Row Height", Float) = 1
		_RowOffset("Row Offset", Float) = 1
		_FakeTime("Time", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode27 = tex2D( _MainTex, uv_MainTex );
				
				float2 uv_ScreenTex = packedInput.ase_texcoord5.xy * _ScreenTex_ST.xy + _ScreenTex_ST.zw;
				float4 appendResult76 = (float4(tex2D( _ScreenTex, uv_ScreenTex )));
				float2 uv_StaticTex = packedInput.ase_texcoord5.xy * _StaticTex_ST.xy + _StaticTex_ST.zw;
				float4 blendOpSrc77 = ( appendResult76 * _Intensity );
				float4 blendOpDest77 = tex2D( _StaticTex, uv_StaticTex );
				float4 tex2DNode73 = tex2D( _JumpTex, uv_StaticTex );
				
				surfaceDescription.BaseColor = tex2DNode27.rgb;
				...
				surfaceDescription.Emission = ( ( saturate( ( 1.0 - ( 1.0 - blendOpSrc77 ) * ( 1.0 - blendOpDest77 ) ) )) + ( tex2DNode73 * tex2DNode73.a ) ).rgb;
				surfaceDescription.Smoothness = ( tex2DNode27.a * _Glossiness );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_ScreenTex = packedInput.ase_texcoord2.xy * _ScreenTex_ST.xy + _ScreenTex_ST.zw;
				float4 appendResult76 = (float4(tex2D( _ScreenTex, uv_ScreenTex )));
				float2 uv_StaticTex = packedInput.ase_texcoord2.xy * _StaticTex_ST.xy + _StaticTex_ST.zw;
				float4 blendOpSrc77 = ( appendResult76 * _Intensity );
				float4 blendOpDest77 = tex2D( _StaticTex, uv_StaticTex );
				float4 tex2DNode73 = tex2D( _JumpTex, uv_StaticTex );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_ScreenTex = packedInput.ase_texcoord7.xy * _ScreenTex_ST.xy + _ScreenTex_ST.zw;
				float4 appendResult76 = (float4(tex2D( _ScreenTex, uv_ScreenTex )));
				float2 uv_StaticTex = packedInput.ase_texcoord7.xy * _StaticTex_ST.xy + _StaticTex_ST.zw;
				float4 blendOpSrc77 = ( appendResult76 * _Intensity );
				float4 blendOpDest77 = tex2D( _StaticTex, uv_StaticTex );
				float4 tex2DNode73 = tex2D( _JumpTex, uv_StaticTex );
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1514,840;Inherit;False;Property;_GlitchWaves;Glitch Waves;10;0;Create;True;0;0;0;True;0;False;1;0;0;1000;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1011,672;Inherit;False;Property;_GlitchAmountR;Glitch Amount Red;8;0;Create;False;0;0;0;True;0;False;0.05;0;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;385,336;Inherit;False;Property;_RowHeight;Row Height;11;0;Create;True;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;435,453;Inherit;False;Property;_RowOffset;Row Offset;12;0;Create;True;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-47,199;Half;False;Property;_ScareA;Scare Alpha;6;0;Create;False;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-29,277;Inherit;False;Property;_GlitchAmount;Glitch Amount;7;0;Create;False;0;0;0;True;0;False;0.05;0;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-311.0001,-38.79999;Half;False;Property;_Glossiness;Glossiness;5;0;Create;True;0;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;317.7998,750.3997;Half;False;Property;_Intensity;Intensity;4;0;Create;True;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;75;506.7704,702.574;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;438.7704,887.574;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;72;22.77039,826.574;Inherit;True;Property;_TextureSample5;Texture Sample 0;14;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;73;7.770386,1032.574;Inherit;True;Property;_TextureSample6;Texture Sample 0;14;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;45;2;15;0
WireConnection;85;0;45;2
WireConnection;85;1;24;0
WireConnection;84;0;85;0
WireConnection;28;0;14;0
WireConnection;28;1;86;0
