	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float4 color75 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				
				float4 screenPos = packedInput.ase_texcoord1;
				float eyeDepth59 = LinearEyeDepth(SampleCameraDepth( screenPos.xy ),_ZBufferParams);
				float clampResult66 = clamp( ( abs( ( eyeDepth59 - screenPos.w ) ) * (0.01 + (_FogIntensity - 0.0) * (0.4 - 0.01) / (1.0 - 0.0)) ) , 0.0 , _FogMaxIntensity );
				
				surfaceDescription.Color = float3( 0.5, 0.5, 0.5 );
				surfaceDescription.Emission = color75.rgb;
				surfaceDescription.Alpha = clampResult66;
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.ScreenDepthNode;59;-484,248;Inherit;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenPosInputsNode;58;-746,237;Float;False;1;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;48,365;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;60;-229,298;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;62;-82,364;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;63;-674,515;Inherit;False;Property;_FogIntensity;FogIntensity;0;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
