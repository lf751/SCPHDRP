	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float simplePerlin3D23 = snoise( ( float4( inputMesh.normalOS , 0.0 ) + ( ( _Time * _distortSpeed ) / 5.0 ) ).xyz );
					...
					)
			{
				...
				float2 uv_BurnMask = packedInput.ase_texcoord1.xy * _BurnMask_ST.xy + _BurnMask_ST.zw;
				float2 appendResult80 = (float2(_fireSpeed , _fireSpeed));
				float2 appendResult81 = (float2(( ( ( _TimeParameters.x ) * appendResult80 ) + uv_BurnMask )));
				
				surfaceDescription.Color = float3( 0.5, 0.5, 0.5 );
				surfaceDescription.Emission = ( ( tex2D( _BurnMask, uv_BurnMask ) * tex2D( _FireTexture, appendResult81 ) ) * ( _fireIntensity * ( _TimeParameters.y + 1.5 ) ) ).rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-1417.378,689.0208;Inherit;False;Property;_distortSpeed;distortSpeed;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1120.462,796.8395;Float;False;Constant;_Float2;Float 1;7;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-924.8124,839.9071;Float;False;Property;_ShieldDistortion1;Shield Distortion;3;0;Create;True;0;0;0;False;0;False;0.01;0;0;0.03;0;1;FLOAT;0
...
WireConnection;80;1;19;0
WireConnection;82;0;31;2
...
WireConnection;72;2;43;0
WireConnection;72;6;27;0
ASEEND*/
//CHKSM=DD2B243DA8713A9561AA14A5FADBA34ACD4ADB9F