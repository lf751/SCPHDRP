...
Shader "Custom/DitherTransparency"
{
	Properties
    {
		...
		[NoScaleOffset]_MainTex("albedoMap", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
		{
			...
			)
			{
				...
				float2 uv_MainTex4 = texCoord0.xy;
				...
				float2 uv_normalMap = texCoord0.xy * _normalMap_ST.xy + _normalMap_ST.zw;
				half3 unpack8 = UnpackNormalScale( tex2D( _normalMap, uv_normalMap ), _normalPower );
				unpack8.z = lerp( 1, unpack8.z, saturate(_normalPower) );
				
				float2 uv_metallicMap12 = texCoord0.xy;
				half4 tex2DNode12 = tex2D( _metallicMap, uv_metallicMap12 );
				

				surfaceDescription.BaseColor = tex2DNode4.rgb;
				surfaceDescription.Alpha = dither7;
				surfaceDescription.NormalTS = unpack8;
        ...
        Pass
		{
           ...
           #define SCENEPICKINGPASS 1
			...
			{
				float2 uv_MainTex4 = packedInput.ase_texcoord.xy;
				half4 tex2DNode4 = tex2D( _MainTex, uv_MainTex4 );
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.TexturePropertyNode;1;-819.3599,-449.1016;Inherit;True;Property;_MainTex;albedoMap;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-567.3848,-201.4448;Inherit;False;Property;_AlphaMult;AlphaMult;3;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1053.498,161.3924;Inherit;False;Property;_normalPower;normalPower;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;11;-1097.991,-229.6169;Inherit;True;Property;_metallicMap;metallicMap;4;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;2;-1006.531,274.9215;Inherit;True;Property;_normalMap;normalMap;2;1;[Normal];Create;True;0;0;0;False;0;False;None;None;False;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
WireConnection;14;4;12;1
WireConnection;14;6;12;4
WireConnection;7;0;10;0
ASEEND*/
//CHKSM=1FF62BF017F47542FB3869F843A3DCEE319A65AC